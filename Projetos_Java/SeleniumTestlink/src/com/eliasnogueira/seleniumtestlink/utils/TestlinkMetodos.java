...
public class TestlinkMetodos {
	 ...
	 */
	public static ReportTCResultResponse executarCasoDeTeste(String planoTeste, String projeto, String suite, String casoDeTeste, ExecutionStatus status, String nota) throws MalformedURLException, TestLinkAPIException {
		...
		String bugId = null;																	// setando null para o ID do bug (caso haja integracao com algum bugtracker)
